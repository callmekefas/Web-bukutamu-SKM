      ...
      <div className="w-full max-w-3xl mt-4 sm:mt-8">
        ...
        {submitted ? (
          <div className="bg-white rounded-3xl p-8 sm:p-12 shadow-sm border border-slate-200/80 text-center space-y-6">
            ...
            <div className="pt-6">
              <Link href="/">
                <button className="inline-flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white font-bold py-3.5 px-8 rounded-xl shadow-md hover:shadow-lg transition-all text-sm">
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-10 shadow-sm border border-slate-200/80 space-y-8">
            ...
            <div className="border-b border-slate-100 pb-6 space-y-2 text-center sm:text-left">
              <div className="inline-flex items-center gap-2 text-[11px] font-bold text-blue-600 uppercase tracking-wider bg-blue-50 px-3 py-1 rounded-full border border-blue-100 mb-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-10">
              ...
              <div className="bg-slate-50 border border-slate-200 p-5 rounded-2xl space-y-3">
                ...
                <div className="relative max-w-md">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-3 bg-white border border-slate-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all text-slate-900 shadow-sm"
                  />
                </div>
              ...
              <div className="space-y-6">
                {questions.length === 0 ? (
                  ...
                  questions.map((q, index) => (
                    <div key={q.id} className="p-5 border border-slate-100 bg-white shadow-sm rounded-2xl hover:border-blue-200 transition-colors">
              ...
              <div className="space-y-3">
                ...
                <textarea
                  ...
                  className="w-full p-4 bg-white border border-slate-200 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all text-slate-900 resize-none shadow-sm"
                />
              </div>
              ...
              <button
                ...
                className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-6 rounded-xl shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2 text-sm disabled:opacity-50"
              >
                {loading ? (
                  <>
